import { PostBoxCreate, PostBoxView } from "@/components/posts/post-box";
import type { Post } from "@/components/posts/post-box";
...
export default function Home() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col justify-between py-12 px-6 sm:py-16 sm:px-8 items-start font-inter">
      <header className="flex flex-col text-center items-start sm:text-left">
        <h1 className="text-heading text-2xl font-medium">Hello User</h1>
